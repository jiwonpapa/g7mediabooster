...
| G7 module 배포 산출물 | PASS | 0.4.0, 122,811 bytes, SHA-256 `53b4dc1c…d026`, commit mtime 고정·2회 byte 비교, dev dependency/test 제외, 공식 기능 manifest fail-closed |
...
- G7 배포 압축본·SHA-256: `cargo xtask g7-module-package`
