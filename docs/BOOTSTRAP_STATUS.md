...
| 테스트 | PASS | 공통 Rust 76개 + Linux seccomp 1개 통과, 실패 0 |
| OpenAPI drift | PASS | 생성 계약과 저장본 일치 |
| 커버리지 | PASS | 5,336/6,302 lines, 84.67%, 하한 80% |
...
| worker 수직 경로 | PASS | bounded 원본 stream, 진위 검사, digest, 기본 썸네일, Ready 게시 |
...
| 100개 worker 부하 | PASS | 4000×3000 JPEG, 동시성 4, 26.45 jobs/s, p95 156ms, peak RSS 323,616 KiB, 만료 lease 10/10 복구 |
| 25,000px heavy image | PASS | heavy semaphore 1, native thread 1, 25,000×4,000 JPEG 386ms, peak RSS 24,368 KiB |
...
loop, 원본 검사·기본 썸네일, lifecycle cleanup과 G7 관리자/브라우저 제어 업로더까지 구현됐습니다. 실제 R2/Lightsail
