...
| 6 G5/G7 연동 | PARTIAL | G5 5.6.24는 core-free module·실제 browser single/multipart·첨부 2개·private 전달 PASS. G7은 현재 checkout patch 5개·계약 28/28+parser·첨부/권한/layout/count DB 회귀와 실제 browser upload/create/update/private thumbnail·403 권한 매트릭스·보존 gate PASS | G7 patch 정식 upstream commit과 실 provider 보존 만료 삭제 |
