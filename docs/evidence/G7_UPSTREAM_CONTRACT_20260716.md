...
- patch `0001`~`0005`: 현재 기준에 순차 clean apply
- 정적 계약: 28/28 PASS
...
- G7 module 0.3.1: PHP 55 tests/139 assertions, TS 17 tests, typecheck/build PASS
...
통과했습니다. patch 적용을 전제로 이 통과 범위만 공식 게시하며 실브라우저 거부 매트릭스와
실 provider 만료 삭제는 아직 게시하지 않습니다. 설치·초기 화면은
