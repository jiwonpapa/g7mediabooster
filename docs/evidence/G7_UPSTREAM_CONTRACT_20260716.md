...
- patch `0001`과 core overlay patch `0002`: 현재 기준에 순차 clean apply
- 정적 계약: 21/21 PASS
...
기존 기준선입니다. 실제 object storage 전송과 create/update·비밀글·삭제/복원 smoke 전에는
게시물 자동 첨부 연동을 공식 배포 기능으로 게시하지 않습니다. 설치·화면 증거는
[`G7_BROWSER_SMOKE_20260716.md`](G7_BROWSER_SMOKE_20260716.md)에 분리했습니다.
