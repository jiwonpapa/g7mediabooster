...
`0001`~`0006` 적용을 전제로 공식 게시합니다. 0.4.2의 activation capability gate와 관리자 워터마크 자산 선택·rollback을
...
`output/releases/jiwonpapa-g7mediabooster-0.4.2.zip`과 서버 수동 배치용 `.tar.gz`, 각각의
