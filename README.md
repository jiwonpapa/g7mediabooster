...
form/Ready attachment bridge·보존 삭제 대조 후보까지 연결됐습니다. G7 격리 설치·관리자 설정과 MinIO 기반 실제 browser single/multipart 전송·create/update·private thumbnail 전달도 통과했습니다. 실제 R2/Lightsail과 G7 권한·삭제/복원 등 남은 게이트는 구현
