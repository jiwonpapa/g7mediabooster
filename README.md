...
- [서명된 공개 썸네일 전달](docs/PUBLIC_THUMBNAIL_DELIVERY.md)
- [썸네일 서버·Thumbor 보안 검토](docs/THUMBNAIL_SERVER_SECURITY_REVIEW_20260724.md)
- [얼굴 중심 크롭 구현 전 보안 계약](docs/FACE_FOCAL_POINT_SECURITY_CONTRACT.md)
- [개발·검증 방법](docs/DEVELOPMENT.md)
- [Python-first 하네스 언어 거버넌스](docs/HARNESS_GOVERNANCE.md)
...
- [Python 하네스 전환과 G7 실제 레이아웃 복구](docs/evidence/PYTHON_HARNESS_AND_G7_LAYOUT_20260717.md)
...
scripts/    OS 진입점과 Python 하네스 호환 래퍼
tools/      Python 배포·SSH·통합 하네스와 언어/크기 거버넌스
xtask/      Rust 품질 게이트와 저장소 명령 표면
```
